...
<div class="card">
    ...
    <ul class="insight-list">
        <li><strong>实时进度仪表</strong>拼图页面即时显示完成度与剩余块数，搭配更宽容的吸附算法，容错再升级。</li>
        <li><strong>个性化计时器</strong>本地记录最佳成绩，适合自我挑战或团队竞赛，随时检验拼图手感。</li>
        <li><strong>辅助面板</strong>可调节吸附距离、底图透明度，并支持“预览原图”“重新打乱”等实用动作。</li>
    </ul>
</div>

<div class="card">
    <h2>想象空间（实验提案）</h2>
    <p class="muted">以下设想暂未上线，欢迎给管理员留言共创未来：</p>
    <ul>
        <li>多人协作拼图房间，实时语音 + 表情互动。</li>
        <li>AI 智能助手自动推荐下一块可能的位置。</li>
        <li>可穿戴设备联动，让拼图延伸到现实桌面。</li>
    </ul>
</div>
